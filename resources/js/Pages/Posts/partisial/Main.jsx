...
function ListBox({ animes, onSelectedAnime }){
    ...
    return(
        <div className="box">
            ...
            {isOpen1 && (
                <AnimaList animes={animes} onSelectedAnime={onSelectedAnime }/>
            )}
        </div>
    )
}
function AnimaList({animes, onSelectedAnime }){
    return(
...
function SelectedBox ({selectedAnime}){
    ...
    return(
        <div className="box">
            ...
            {isOpen2 && (
                <AnimaDetail selectedAnime={selectedAnime} />
            )}
        </div>
    )
}
function AnimaDetail({ selectedAnime }) {
    return(
